// In gameEngine file we have functions that will be used in the Engine.js file.
...
// Enemy class. To get more information about the argument that will get passed to gameEngine function,
// please see the Engine.js file.

// The purpose of gameEngine function is to determine in which slot to place our next enemy.
...
const nextEnemySpot = (enemies) => {
  ...
  // We don't want to place two enemies in the same lane. To accomplish gameEngine, we first create an
  ...
  // We can use gameEngine property to modify the spotsTaken array.
